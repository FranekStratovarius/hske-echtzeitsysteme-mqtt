...
def detect(filepath, file):
	...
	# if g_circles is not None:
	# 	print("green: " + str(len(g_circles)))
	# if r_circles is not None:
	# 	print("red: " + str(len(r_circles)))

	if g_circles is None and r_circles is None:
		print("nothing")
	elif g_circles is not None and r_circles is None:
		print("green")
	elif r_circles is not None and g_circles is None:
		print("red")
	elif len(g_circles) == 0 and len(r_circles) == 0:
		print("nothing")
	elif len(g_circles) > len(r_circles):
		print("green")
	else:
		print("red")
